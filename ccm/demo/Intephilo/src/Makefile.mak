...
Observing.idl: Observing.class ObservingHome.class
	$(JAVA2IDL) $(JAVA2IDL_FLAGS) -classpath $(CLASSPATH) Dinner.Observing
	$(JAVA2IDL) $(JAVA2IDL_FLAGS) -classpath $(CLASSPATH) Dinner.ObservingHome
!else
Observing.idl:
!endif

DLLS = Dinner StdDinner EJB
...
CCM_Dinner.idl: Dinner.idl3 Observing.idl
	$(IDL3) -I. $(CCM_IDL3FLAGS) -I$(OB_IDLDIR) -I$(OB_IDLDIR)/tao -I$(CCM_IDLDIR) -I$(OTS_IDLDIR) Dinner.idl3
...
!else
CCM_Dinner.idl: Dinner.idl3 Observing.idl
	$(IDL3) -I. $(CCM_IDL3FLAGS) -I$(OB_IDLDIR) -I$(CCM_IDLDIR) -I$(OTS_IDLDIR) -I$(PSS_IDLDIR) Dinner.idl3
	$(IDL)  -I. $(OB_IDLFLAGS) -I$(CCM_IDLDIR) -I$(OTS_IDLDIR) -I$(PSS_IDLDIR) Dinner.idl
	$(IDL)  -I. $(OB_IDLFLAGS) -I$(OB_IDLDIR) Observing.idl

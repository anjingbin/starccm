                               ...
                               implements PrimitiveDef
{
    ...
    final public static java.lang.Class _star_opsClass = PrimitiveDefOperations.class;
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    PrimitiveKind _star_r = PrimitiveKindHelper.read(in);
                    return _star_r;
                }
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("kind", _star_opsClass);
                if(_star_so == null)
                    continue;
                PrimitiveDefOperations _star_self = (PrimitiveDefOperations)_star_so.servant;
                try
                {
                    return _star_self.kind();
                }
                finally
                {

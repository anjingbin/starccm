...
//
final public class UnionDefHelper
{
    public static void
    insert(org.omg.CORBA.Any any, UnionDef val)
    {
        any.insert_Object(val, type());
    }

    public static UnionDef
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "UnionDef");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _UnionDefStub _star_stub = new _UnionDefStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, UnionDef val)
    {

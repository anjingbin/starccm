...
//
final public class WstringDefHelper
{
    public static void
    insert(org.omg.CORBA.Any any, WstringDef val)
    {
        any.insert_Object(val, type());
    }

    public static WstringDef
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "WstringDef");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _WstringDefStub _star_stub = new _WstringDefStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, WstringDef val)
    {

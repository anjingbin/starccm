...
//
public class _SequenceDefStub extends org.omg.CORBA.portable.ObjectImpl
                              implements SequenceDef
{
    ...
    final public static java.lang.Class _star_opsClass = SequenceDefOperations.class;
    ...
    bound()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                SequenceDefOperations _star_self = (SequenceDefOperations)_star_so.servant;
                try
                {

...
//
final public class ExceptionDefHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "ExceptionDef");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ExceptionDefStub _star_stub = new _ExceptionDefStub();

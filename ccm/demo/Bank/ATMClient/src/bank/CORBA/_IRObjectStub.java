...
//
public class _IRObjectStub extends org.omg.CORBA.portable.ObjectImpl
                           implements IRObject
{
    ...
    final public static java.lang.Class _star_opsClass = IRObjectOperations.class;
    ...
    def_kind()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                IRObjectOperations _star_self = (IRObjectOperations)_star_so.servant;
                try
                {

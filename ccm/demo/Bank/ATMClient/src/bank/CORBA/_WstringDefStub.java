...
//
public class _WstringDefStub extends org.omg.CORBA.portable.ObjectImpl
                             implements WstringDef
{
    ...
    final public static java.lang.Class _star_opsClass = WstringDefOperations.class;

    //
    // IDL:omg.org/CORBA/WstringDef/bound:1.0
    //
    public int
    bound()
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("bound", _star_opsClass);
                if(_star_so == null)
                    continue;
                WstringDefOperations _star_self = (WstringDefOperations)_star_so.servant;
                try
                {
                    return _star_self.bound();
                }
                finally
                {

...
//
final public class PrimitiveDefHelper
{
    public static void
    insert(org.omg.CORBA.Any any, PrimitiveDef val)
    {
        any.insert_Object(val, type());
    }

    public static PrimitiveDef
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "PrimitiveDef");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _PrimitiveDefStub _star_stub = new _PrimitiveDefStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, PrimitiveDef val)
    {

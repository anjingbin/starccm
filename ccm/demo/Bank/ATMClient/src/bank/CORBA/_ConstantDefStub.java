...
//
public class _ConstantDefStub extends org.omg.CORBA.portable.ObjectImpl
                              implements ConstantDef
{
    ...
    final public static java.lang.Class _star_opsClass = ConstantDefOperations.class;
    ...
    type()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ConstantDefOperations _star_self = (ConstantDefOperations)_star_so.servant;
                try
                {
    ...
    value()
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("_get_value", true);
                    in = _invoke(out);
                    org.omg.CORBA.Any _star_r = in.read_any();
                    return _star_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _star_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("value", _star_opsClass);
                if(_star_so == null)
                    continue;
                ConstantDefOperations _star_self = (ConstantDefOperations)_star_so.servant;
                try
                {
                    return _star_self.value();
                }
                finally
                {
                    _servant_postinvoke(_star_so);
    ...
    public void
    value(org.omg.CORBA.Any _star_a)
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("_set_value", true);
                    out.write_any(_star_a);
                    in = _invoke(out);
                    return;
                }
                catch(org.omg.CORBA.portable.RemarshalException _star_ex)

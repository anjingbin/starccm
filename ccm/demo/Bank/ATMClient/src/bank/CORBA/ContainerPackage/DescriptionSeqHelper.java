...
//
final public class DescriptionSeqHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "DescriptionSeq", orb.create_sequence_tc(0, DescriptionHelper.type()));
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _star_v = new Description[len0];
        for(int i0 = 0 ; i0 < len0 ; i0++)
            _star_v[i0] = DescriptionHelper.read(in);
        return _star_v;
    }
    ...
    write(org.omg.CORBA.portable.OutputStream out, Description[] val)
    {
        ...
        for(int i0 = 0 ; i0 < len0 ; i0++)
            DescriptionHelper.write(out, val[i0]);
    }
}

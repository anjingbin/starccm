...
//
public class _NativeDefStub extends org.omg.CORBA.portable.ObjectImpl
                            implements NativeDef
{
    ...
    final public static java.lang.Class _star_opsClass = NativeDefOperations.class;
    ...
    id()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                NativeDefOperations _star_self = (NativeDefOperations)_star_so.servant;
                try
                {

...
final public class OperationDescriptionHelper
{
    ...
    {
        OperationDescription _star_v = new OperationDescription();
        ...
        _star_v.result = in.read_TypeCode();
        _star_v.mode = OperationModeHelper.read(in);
        _star_v.contexts = ContextIdSeqHelper.read(in);
        _star_v.parameters = ParDescriptionSeqHelper.read(in);
        _star_v.exceptions = ExcDescriptionSeqHelper.read(in);
        return _star_v;
    }

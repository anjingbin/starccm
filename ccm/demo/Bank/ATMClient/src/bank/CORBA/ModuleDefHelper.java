...
//
final public class ModuleDefHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ModuleDef val)
    {
        any.insert_Object(val, type());
    }

    public static ModuleDef
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "ModuleDef");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ModuleDefStub _star_stub = new _ModuleDefStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, ModuleDef val)
    {

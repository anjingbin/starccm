...
//
final public class UnionMemberHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[1].name = "label";
            members[1].type = orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_any);

            members[2] = new org.omg.CORBA.StructMember();
            members[2].name = "type";
            members[2].type = orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_TypeCode);

            members[3] = new org.omg.CORBA.StructMember();
            members[3].name = "type_def";
            members[3].type = IDLTypeHelper.type();

            typeCode_ = orb.create_struct_tc(id(), "UnionMember", members);
        }
    ...
    {
        UnionMember _star_v = new UnionMember();
        _star_v.name = IdentifierHelper.read(in);
        _star_v.label = in.read_any();

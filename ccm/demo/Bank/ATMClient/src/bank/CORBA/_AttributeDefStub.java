                               ...
                               implements AttributeDef
{
    ...
    final public static java.lang.Class _star_opsClass = AttributeDefOperations.class;
    ...
    type()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                AttributeDefOperations _star_self = (AttributeDefOperations)_star_so.servant;
                try
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    AttributeMode _star_r = AttributeModeHelper.read(in);
                    return _star_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _star_ex)
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    AttributeModeHelper.write(out, _star_a);
                    in = _invoke(out);
                    return;
                }
                catch(org.omg.CORBA.portable.RemarshalException _star_ex)

...
//
final public class ServiceDetailHelper
{
    public static void
    ...
    {
        ServiceDetail _star_v = new ServiceDetail();
        _star_v.service_detail_type = ServiceDetailTypeHelper.read(in);
        int len0 = in.read_ulong();
        _star_v.service_detail = new byte[len0];
        in.read_octet_array(_star_v.service_detail, 0, len0);
        return _star_v;
    }

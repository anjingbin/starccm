...
final public class ValueDescriptionHelper
{
    ...
    {
        ValueDescription _star_v = new ValueDescription();
        ...
        _star_v.supported_interfaces = RepositoryIdSeqHelper.read(in);
        _star_v.abstract_base_values = RepositoryIdSeqHelper.read(in);
        _star_v.is_truncatable = in.read_boolean();
        _star_v.base_value = RepositoryIdHelper.read(in);
        return _star_v;
    }

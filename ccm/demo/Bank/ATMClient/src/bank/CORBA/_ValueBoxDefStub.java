...
//
public class _ValueBoxDefStub extends org.omg.CORBA.portable.ObjectImpl
                              implements ValueBoxDef
{
    ...
    final public static java.lang.Class _star_opsClass = ValueBoxDefOperations.class;
    ...
    original_type_def()
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("original_type_def", _star_opsClass);
                if(_star_so == null)
                    continue;
                ValueBoxDefOperations _star_self = (ValueBoxDefOperations)_star_so.servant;
                try
                {
                    return _star_self.original_type_def();
                }
                finally
                {
    ...
    public void
    original_type_def(IDLType _star_a)
    {
        while(true)
        {
            if(!this._is_local())
            ...
            else
            {
                ...
                try
                {
                    _star_self.original_type_def(_star_a);
                    return;
                }
                finally
                {

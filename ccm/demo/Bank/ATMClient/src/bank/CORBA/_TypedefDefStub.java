...
//
public class _TypedefDefStub extends org.omg.CORBA.portable.ObjectImpl
                             implements TypedefDef
{
    ...
    final public static java.lang.Class _star_opsClass = TypedefDefOperations.class;
    ...
    id()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                TypedefDefOperations _star_self = (TypedefDefOperations)_star_so.servant;
                try
                {

...
//
final public class StandardConfiguratorHelper
{
    public static void
    insert(org.omg.CORBA.Any any, StandardConfigurator val)
    {
        any.insert_Object(val, type());
    }

    public static StandardConfigurator
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "StandardConfigurator");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        try
        {
            return (StandardConfigurator)_star_v;
        }
        ...
        _StandardConfiguratorStub _star_stub = new _StandardConfiguratorStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, StandardConfigurator val)
    {
    ...
    narrow(org.omg.CORBA.Object val)
    {
        if(val != null)
        {
            try
            {
                return (StandardConfigurator)val;
            }
            catch(ClassCastException ex)
            {
            }

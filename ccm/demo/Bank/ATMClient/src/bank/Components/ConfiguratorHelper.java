...
//
final public class ConfiguratorHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Configurator val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Configurator");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ConfiguratorStub _star_stub = new _ConfiguratorStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Configurator val)
    {

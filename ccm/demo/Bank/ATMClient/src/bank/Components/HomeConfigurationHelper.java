...
//
final public class HomeConfigurationHelper
{
    public static void
    insert(org.omg.CORBA.Any any, HomeConfiguration val)
    {
        any.insert_Object(val, type());
    }

    public static HomeConfiguration
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "HomeConfiguration");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        try
        {
            return (HomeConfiguration)_star_v;
        }
        ...
        _HomeConfigurationStub _star_stub = new _HomeConfigurationStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, HomeConfiguration val)
    {

...
//
final public class HomeFinderHelper
{
    public static void
    insert(org.omg.CORBA.Any any, HomeFinder val)
    {
        any.insert_Object(val, type());
    }

    public static HomeFinder
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "HomeFinder");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _HomeFinderStub _star_stub = new _HomeFinderStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, HomeFinder val)
    {

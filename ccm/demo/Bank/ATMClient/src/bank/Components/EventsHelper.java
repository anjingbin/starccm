...
{
    public static void
    insert(org.omg.CORBA.Any any, Events val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Events");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _EventsStub _star_stub = new _EventsStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Events val)
    {

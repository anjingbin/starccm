...
//
public class _DynamicConnectConfiguratorStub extends org.omg.CORBA.portable.ObjectImpl
                                             implements DynamicConnectConfigurator
{
    ...
    final public static java.lang.Class _star_opsClass = DynamicConnectConfiguratorOperations.class;

    //
    // IDL:omg.org/Components/DynamicConnectConfigurator/set_connect_configuration:1.0
    //
    public void
    set_connect_configuration(DynamicConnectInfo[] _star_a0)
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("set_connect_configuration", true);
                    DynamicConnectInfosHelper.write(out, _star_a0);
                    in = _invoke(out);
                    return;
                }
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("set_connect_configuration", _star_opsClass);
                if(_star_so == null)
                    continue;
                DynamicConnectConfiguratorOperations _star_self = (DynamicConnectConfiguratorOperations)_star_so.servant;
                try
                {
                    _star_self.set_connect_configuration(_star_a0);
                    return;
                }
                finally
                {

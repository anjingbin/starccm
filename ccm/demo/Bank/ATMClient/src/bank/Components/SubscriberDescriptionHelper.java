...
//
final public class SubscriberDescriptionHelper
{
    public static void
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            if(_star_v == null || _star_v instanceof SubscriberDescription)
                return (SubscriberDescription)_star_v;
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[1].name = "consumer";
            members[1].type = EventConsumerBaseHelper.type();
            members[1].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            typeCode_ = orb.create_value_tc(id(), "SubscriberDescription", org.omg.CORBA.VM_NONE.value, null, members);
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (SubscriberDescription)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

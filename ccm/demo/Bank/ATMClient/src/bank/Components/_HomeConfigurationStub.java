...
//
public class _HomeConfigurationStub extends org.omg.CORBA.portable.ObjectImpl
                                    implements HomeConfiguration
{
    ...
    final public static java.lang.Class _star_opsClass = HomeConfigurationOperations.class;

    //
    // IDL:omg.org/Components/HomeConfiguration/set_configurator:1.0
    //
    public void
    set_configurator(Configurator _star_a0)
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    ConfiguratorHelper.write(out, _star_a0);
                    in = _invoke(out);
                    return;
                }
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                HomeConfigurationOperations _star_self = (HomeConfigurationOperations)_star_so.servant;
                try
                {
    ...
    //
    public void
    set_configuration_values(ConfigValue[] _star_a0)
    {
        while(true)
        {
            if(!this._is_local())

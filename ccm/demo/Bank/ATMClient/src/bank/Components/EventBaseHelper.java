...
//
final public class EventBaseHelper
{
    public static void
    insert(org.omg.CORBA.Any any, EventBase val)
    {
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            if(_star_v == null || _star_v instanceof EventBase)
                return (EventBase)_star_v;
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_value_tc(id(), "EventBase", org.omg.CORBA.VM_ABSTRACT.value, null, members);
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (EventBase)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, EventBase val)
    {

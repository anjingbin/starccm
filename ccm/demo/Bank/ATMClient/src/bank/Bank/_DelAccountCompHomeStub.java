...
//
public class _DelAccountCompHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                     implements DelAccountCompHome
{
    ...
    final public static java.lang.Class _star_opsClass = DelAccountCompHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DelAccountCompHomeOperations _star_self = (DelAccountCompHomeOperations)_star_so.servant;
                try
                {
    ...
    //
    // IDL:Bank/DelAccountCompHomeImplicit/create:1.0
    //
    public DelAccountComp
    create()
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    DelAccountComp _star_r = DelAccountCompHelper.read(in);
                    return _star_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _star_ex)
                {

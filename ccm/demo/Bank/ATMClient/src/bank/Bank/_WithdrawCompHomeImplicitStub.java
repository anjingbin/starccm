...
//
public class _WithdrawCompHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                           implements WithdrawCompHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = WithdrawCompHomeImplicitOperations.class;
        ...
        throws bank.Components.CreateFailure
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                WithdrawCompHomeImplicitOperations _star_self = (WithdrawCompHomeImplicitOperations)_star_so.servant;
                try
                {

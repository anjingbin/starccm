...
//
public class _OpenAccountCompHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                              implements OpenAccountCompHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = OpenAccountCompHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                OpenAccountCompHomeExplicitOperations _star_self = (OpenAccountCompHomeExplicitOperations)_star_so.servant;
                try
                {

...
//
public class _QueryCompHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                implements QueryCompHome
{
    ...
    final public static java.lang.Class _star_opsClass = QueryCompHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                QueryCompHomeOperations _star_self = (QueryCompHomeOperations)_star_so.servant;
                try
                {

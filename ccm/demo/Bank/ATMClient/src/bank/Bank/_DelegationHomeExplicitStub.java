...
//
public class _DelegationHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                         implements DelegationHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = DelegationHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DelegationHomeExplicitOperations _star_self = (DelegationHomeExplicitOperations)_star_so.servant;
                try
                {

...
//
public class _DepositCompStub extends org.omg.CORBA.portable.ObjectImpl
                              implements DepositComp
{
    ...
    final public static java.lang.Class _star_opsClass = DepositCompOperations.class;
    ...
    provide_deposit_op()
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("provide_deposit_op", true);
                    in = _invoke(out);
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("provide_deposit_op", _star_opsClass);
                if(_star_so == null)
                    continue;
                DepositCompOperations _star_self = (DepositCompOperations)_star_so.servant;
                try
                {
                    return _star_self.provide_deposit_op();
                }
                finally
                {

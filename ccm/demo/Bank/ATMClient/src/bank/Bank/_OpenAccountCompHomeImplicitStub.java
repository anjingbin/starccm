...
//
public class _OpenAccountCompHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                              implements OpenAccountCompHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = OpenAccountCompHomeImplicitOperations.class;

    //
    // IDL:Bank/OpenAccountCompHomeImplicit/create:1.0
    //
    public OpenAccountComp
    create()
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    OpenAccountComp _star_r = OpenAccountCompHelper.read(in);
                    return _star_r;
                }
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                OpenAccountCompHomeImplicitOperations _star_self = (OpenAccountCompHomeImplicitOperations)_star_so.servant;
                try
                {

...
//
public class _ManagerHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                      implements ManagerHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = ManagerHomeImplicitOperations.class;
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    Manager _star_r = ManagerHelper.read(in);
                    return _star_r;
                }
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ManagerHomeImplicitOperations _star_self = (ManagerHomeImplicitOperations)_star_so.servant;
                try
                {

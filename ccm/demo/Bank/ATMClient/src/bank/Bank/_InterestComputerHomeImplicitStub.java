...
//
public class _InterestComputerHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                               implements InterestComputerHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = InterestComputerHomeImplicitOperations.class;
        ...
        throws bank.Components.CreateFailure
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                InterestComputerHomeImplicitOperations _star_self = (InterestComputerHomeImplicitOperations)_star_so.servant;
                try
                {

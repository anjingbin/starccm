...
//
public class _DepositCompHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                  implements DepositCompHome
{
    ...
    final public static java.lang.Class _star_opsClass = DepositCompHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DepositCompHomeOperations _star_self = (DepositCompHomeOperations)_star_so.servant;
                try
                {

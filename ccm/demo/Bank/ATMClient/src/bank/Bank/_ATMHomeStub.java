...
//
// IDL:Bank/ATMHome:1.0
//
public class _ATMHomeStub extends org.omg.CORBA.portable.ObjectImpl
                          implements ATMHome
{
    ...
    final public static java.lang.Class _star_opsClass = ATMHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ATMHomeOperations _star_self = (ATMHomeOperations)_star_so.servant;
                try
                {

...
//
public class _OpenAccountCompStub extends org.omg.CORBA.portable.ObjectImpl
                                  implements OpenAccountComp
{
    ...
    final public static java.lang.Class _star_opsClass = OpenAccountCompOperations.class;
    ...
    provide_open_account_op()
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("provide_open_account_op", true);
                    in = _invoke(out);
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("provide_open_account_op", _star_opsClass);
                if(_star_so == null)
                    continue;
                OpenAccountCompOperations _star_self = (OpenAccountCompOperations)_star_so.servant;
                try
                {
                    return _star_self.provide_open_account_op();
                }
                finally
                {

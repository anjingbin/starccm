...
//
public class _DelAccountCompStub extends org.omg.CORBA.portable.ObjectImpl
                                 implements DelAccountComp
{
    ...
    final public static java.lang.Class _star_opsClass = DelAccountCompOperations.class;
    ...
    provide_del_account_op()
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("provide_del_account_op", true);
                    in = _invoke(out);
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("provide_del_account_op", _star_opsClass);
                if(_star_so == null)
                    continue;
                DelAccountCompOperations _star_self = (DelAccountCompOperations)_star_so.servant;
                try
                {
                    return _star_self.provide_del_account_op();
                }
                finally
                {

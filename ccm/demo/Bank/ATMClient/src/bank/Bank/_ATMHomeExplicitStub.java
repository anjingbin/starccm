...
//
public class _ATMHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                  implements ATMHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = ATMHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ATMHomeExplicitOperations _star_self = (ATMHomeExplicitOperations)_star_so.servant;
                try
                {

...
//
public class _WithdrawCompHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                           implements WithdrawCompHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = WithdrawCompHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                WithdrawCompHomeExplicitOperations _star_self = (WithdrawCompHomeExplicitOperations)_star_so.servant;
                try
                {

...
//
public class _AccountHomeStub extends org.omg.CORBA.portable.ObjectImpl
                              implements AccountHome
{
    ...
    final public static java.lang.Class _star_opsClass = AccountHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                AccountHomeOperations _star_self = (AccountHomeOperations)_star_so.servant;
                try
                {

...
//
public class _DelegationHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                 implements DelegationHome
{
    ...
    final public static java.lang.Class _star_opsClass = DelegationHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DelegationHomeOperations _star_self = (DelegationHomeOperations)_star_so.servant;
                try
                {

...
//
public class _ManagerHomeStub extends org.omg.CORBA.portable.ObjectImpl
                              implements ManagerHome
{
    ...
    final public static java.lang.Class _star_opsClass = ManagerHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ManagerHomeOperations _star_self = (ManagerHomeOperations)_star_so.servant;
                try
                {

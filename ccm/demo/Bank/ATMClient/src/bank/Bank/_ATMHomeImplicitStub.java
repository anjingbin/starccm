...
//
public class _ATMHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                  implements ATMHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = ATMHomeImplicitOperations.class;
        ...
        throws bank.Components.CreateFailure
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ATMHomeImplicitOperations _star_self = (ATMHomeImplicitOperations)_star_so.servant;
                try
                {

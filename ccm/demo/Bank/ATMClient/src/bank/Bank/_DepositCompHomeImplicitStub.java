...
//
public class _DepositCompHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                          implements DepositCompHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = DepositCompHomeImplicitOperations.class;
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    DepositComp _star_r = DepositCompHelper.read(in);
                    return _star_r;
                }
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DepositCompHomeImplicitOperations _star_self = (DepositCompHomeImplicitOperations)_star_so.servant;
                try
                {

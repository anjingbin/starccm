...
//
public class _QueryCompHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                        implements QueryCompHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = QueryCompHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                QueryCompHomeExplicitOperations _star_self = (QueryCompHomeExplicitOperations)_star_so.servant;
                try
                {

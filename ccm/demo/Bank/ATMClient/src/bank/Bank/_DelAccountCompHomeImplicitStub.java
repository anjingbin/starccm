...
//
public class _DelAccountCompHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                             implements DelAccountCompHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = DelAccountCompHomeImplicitOperations.class;
        ...
        throws bank.Components.CreateFailure
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DelAccountCompHomeImplicitOperations _star_self = (DelAccountCompHomeImplicitOperations)_star_so.servant;
                try
                {

...
// IDL:Bank/ATMOp:1.0
//
final public class ATMOpHelper
{
    public static void
    insert(org.omg.CORBA.Any any, ATMOp val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "ATMOp");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ATMOpStub _star_stub = new _ATMOpStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, ATMOp val)
    {

...
//
public class _InterestComputerHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                               implements InterestComputerHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = InterestComputerHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                InterestComputerHomeExplicitOperations _star_self = (InterestComputerHomeExplicitOperations)_star_so.servant;
                try
                {

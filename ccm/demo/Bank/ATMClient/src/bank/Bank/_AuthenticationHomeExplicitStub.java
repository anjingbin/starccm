...
//
public class _AuthenticationHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                             implements AuthenticationHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = AuthenticationHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                AuthenticationHomeExplicitOperations _star_self = (AuthenticationHomeExplicitOperations)_star_so.servant;
                try
                {

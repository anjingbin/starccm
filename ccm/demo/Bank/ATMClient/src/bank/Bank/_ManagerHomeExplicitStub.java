...
//
public class _ManagerHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                      implements ManagerHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = ManagerHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                ManagerHomeExplicitOperations _star_self = (ManagerHomeExplicitOperations)_star_so.servant;
                try
                {

                          ...
                          implements Account
{
    ...
    final public static java.lang.Class _star_opsClass = AccountOperations.class;
    ...
    provide_account_op()
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("provide_account_op", true);
                    in = _invoke(out);
            ...
            {
                org.omg.CORBA.portable.ServantObject _star_so = _servant_preinvoke("provide_account_op", _star_opsClass);
                if(_star_so == null)
                    continue;
                AccountOperations _star_self = (AccountOperations)_star_so.servant;
                try
                {
                    return _star_self.provide_account_op();
                }
                finally
                {

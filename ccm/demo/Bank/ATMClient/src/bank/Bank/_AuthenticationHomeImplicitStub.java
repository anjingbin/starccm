...
//
public class _AuthenticationHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                             implements AuthenticationHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = AuthenticationHomeImplicitOperations.class;

    //
    // IDL:Bank/AuthenticationHomeImplicit/create:1.0
    //
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    Authentication _star_r = AuthenticationHelper.read(in);
                    return _star_r;
                }
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                AuthenticationHomeImplicitOperations _star_self = (AuthenticationHomeImplicitOperations)_star_so.servant;
                try
                {

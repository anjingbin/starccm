...
{
    public static void
    insert(org.omg.CORBA.Any any, Manager val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Manager");
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ManagerStub _star_stub = new _ManagerStub();
        _star_stub._set_delegate(_star_impl._get_delegate());
        return _star_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Manager val)
    {

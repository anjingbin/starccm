...
//
public class _AuthenticationHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                     implements AuthenticationHome
{
    ...
    final public static java.lang.Class _star_opsClass = AuthenticationHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                AuthenticationHomeOperations _star_self = (AuthenticationHomeOperations)_star_so.servant;
                try
                {

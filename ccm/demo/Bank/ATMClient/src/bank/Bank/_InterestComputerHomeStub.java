...
//
public class _InterestComputerHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                       implements InterestComputerHome
{
    ...
    final public static java.lang.Class _star_opsClass = InterestComputerHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                InterestComputerHomeOperations _star_self = (InterestComputerHomeOperations)_star_so.servant;
                try
                {
    ...
    //
    // IDL:Bank/InterestComputerHomeImplicit/create:1.0
    //
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    InterestComputer _star_r = InterestComputerHelper.read(in);
                    return _star_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _star_ex)
                {

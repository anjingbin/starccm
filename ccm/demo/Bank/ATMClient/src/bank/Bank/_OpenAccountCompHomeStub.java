...
//
public class _OpenAccountCompHomeStub extends org.omg.CORBA.portable.ObjectImpl
                                      implements OpenAccountCompHome
{
    ...
    final public static java.lang.Class _star_opsClass = OpenAccountCompHomeOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                OpenAccountCompHomeOperations _star_self = (OpenAccountCompHomeOperations)_star_so.servant;
                try
                {

...
//
public class _DepositCompHomeExplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                          implements DepositCompHomeExplicit
{
    ...
    final public static java.lang.Class _star_opsClass = DepositCompHomeExplicitOperations.class;
    ...
    set_configurator(bank.Components.Configurator _star_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                DepositCompHomeExplicitOperations _star_self = (DepositCompHomeExplicitOperations)_star_so.servant;
                try
                {

...
//
public class _AccountHomeImplicitStub extends org.omg.CORBA.portable.ObjectImpl
                                      implements AccountHomeImplicit
{
    ...
    final public static java.lang.Class _star_opsClass = AccountHomeImplicitOperations.class;
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    Account _star_r = AccountHelper.read(in);
                    return _star_r;
                }
            ...
            else
            {
                ...
                if(_star_so == null)
                    continue;
                AccountHomeImplicitOperations _star_self = (AccountHomeImplicitOperations)_star_so.servant;
                try
                {

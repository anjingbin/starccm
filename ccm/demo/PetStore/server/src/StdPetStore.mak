...
DLL_NAME	= ..\bin\StdPetStore.dll
PDB_NAME	= ..\bin\StdPetStore.pdb
IMP_LIB		= ..\bin\StdPetStore.lib
EXP_NAME	= ..\bin\StdPetStore.exp
...
OBJS	=   CCM_PetStore.obj \
	CCM_PetStore_impl.obj \
	CCM_PetStore_skel.obj \
	PetStore_psdl.obj \
	PetStore_pss.obj \
	PetStore.obj \
	PetStore_ValueType_impl.obj \
	StdPetStoreDll.obj

ALL_IDLFLAGS	= $(OB_IDLFLAGS) $(OTS_IDLFLAGS) $(PSS_IDLFLAGS) $(CCM_IDLFLAGS)

ALL_CXXFLAGS	= $(CXXFLAGS) $(PDB_FLAGS) /DPSSDLL

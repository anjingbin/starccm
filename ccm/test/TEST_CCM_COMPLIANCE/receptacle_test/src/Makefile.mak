...
DLLS = StdTestDll TestDll receptacle_client
...
install:: all
	if exist $(top_srcdir)\bin\receptacle.zip \
		$(top_srcdir)\bin\unzip.exe -o -d temp $(top_srcdir)\bin\receptacle.zip
	copy ..\bin\TestDll.dll temp\Person\bb38d965-1e54-11d7-9b85-8a6194305b45
	copy ..\bin\StdTestDll.dll temp\Person\bb38d965-1e54-11d7-9b85-8a6194305b45
	copy ..\bin\TestDll.dll temp\talk\fcda6382-287e-11d7-9c64-f6a003291bf5
	copy ..\bin\StdTestDll.dll temp\talk\fcda6382-287e-11d7-9c64-f6a003291bf5
	cd temp & \
	$(top_srcdir)\..\bin\zip.exe -r receptacle.zip * & \
	move receptacle.zip $(bindir)
	$(top_srcdir)\bin\rm -rf temp
	
	copy ..\bin\receptacle_client.exe $(bindir)

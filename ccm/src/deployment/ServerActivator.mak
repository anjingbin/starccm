...
EXE_NAME	= $(top_srcdir)\bin\ServerActivator.exe
PDB_NAME	= $(top_srcdir)\bin\ServerActivator.pdb
PDB_FILES	= $(PDB_NAME) 
...
EXE_OBJS	=ServerActivator_impl.obj \
                ServerActivatorServer.obj \
                Manager_skel.obj\
		Manager.obj \
		PerformanceManager_impl.obj

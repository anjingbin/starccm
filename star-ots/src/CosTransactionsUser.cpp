...
"010000000e00000044000000010000002800000049444c3a436f735472616e73616374696f6e7"
...
//
void
CosTransactions::Synchronization_broker::after_completion(::CosTransactions::Status _star_a0)
{
    bool _star_retry = true;
    while(true)
    {

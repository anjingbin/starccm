...
#ifndef STAR_OTS_CURRENT_IMPL_H
#define STAR_OTS_CURRENT_IMPL_H

#include <STAR/PICurrent_fwd.h>
...
public:
    ...
    //
	//renyi 6 6:added
    void setTransactionFactory(CosTransactions::TransactionFactory_ptr);//renyi 6 9:STARCosTransactions--->CosTransactions

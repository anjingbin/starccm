...
class TransactionFactory_broker : virtual public CosTransactions::TransactionFactory,
                                  virtual public STARCORBA::Object
{
    TransactionFactory_broker(const TransactionFactory_broker&);
    void operator=(const TransactionFactory_broker&);

public:

    TransactionFactory_broker() { }
    virtual ~TransactionFactory_broker() { }
...
class Control_broker : virtual public CosTransactions::Control,
                       virtual public STARCORBA::Object
{
    Control_broker(const Control_broker&);
    void operator=(const Control_broker&);

public:

    Control_broker() { }
    virtual ~Control_broker() { }
...
class Terminator_broker : virtual public CosTransactions::Terminator,
                          virtual public STARCORBA::Object
{
    Terminator_broker(const Terminator_broker&);
    void operator=(const Terminator_broker&);

public:

    Terminator_broker() { }
    virtual ~Terminator_broker() { }
...
//SuLiang add.
    ...
    //
    // Operation declare ::CosTransactions::Coordinator::register_synchronization
    //
...
class Coordinator_broker : virtual public CosTransactions::Coordinator,
                           virtual public STARCORBA::Object
{
    Coordinator_broker(const Coordinator_broker&);
    void operator=(const Coordinator_broker&);

public:

    Coordinator_broker() { }
    virtual ~Coordinator_broker() { }
...
class RecoveryCoordinator_broker : virtual public CosTransactions::RecoveryCoordinator,
                                   virtual public STARCORBA::Object
{
    RecoveryCoordinator_broker(const RecoveryCoordinator_broker&);
    void operator=(const RecoveryCoordinator_broker&);

public:

    RecoveryCoordinator_broker() { }
    virtual ~RecoveryCoordinator_broker() { }
...
class TransactionalObject_broker : virtual public CosTransactions::TransactionalObject,
                                   virtual public STARCORBA::Object
{
    TransactionalObject_broker(const TransactionalObject_broker&);
    void operator=(const TransactionalObject_broker&);

public:

    TransactionalObject_broker() { }
    virtual ~TransactionalObject_broker() { }

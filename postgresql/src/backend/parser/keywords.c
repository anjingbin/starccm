 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/hjcvs/OB-CCM-1.0/postgresql/src/backend/parser/keywords.c,v 1.1 2003/12/30 00:06:07 AnJingBin Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
static ScanKeyword ScanKeywords[] = {
	...
	{"work", WORK},
	//renyi 10 29
	{"xacommit",            XACOMMIT_TRANS  },
	{"xaprepare",           XAPREPARE_TRANS }, 
	{"xarollback",          XAROLLBACK_TRANS},
	{"year", YEAR_P},
	{"zone", ZONE},
};

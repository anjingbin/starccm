 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/hjcvs/OB-CCM-1.0/postgresql/src/backend/executor/functions.c,v 1.2 2004/07/05 08:55:28 SuLiang Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
postquel_getnext(execution_state *es)
{
	...
	if (es->qd->operation == CMD_UTILITY)
	{
		...
		int i=2;//renyi 11 24 : added
		//renyi 11 24 : changed
		ProcessUtility(es->qd->parsetree->utilityStmt, es->qd->dest, NULL,&i);
